            ...
            <div class="bee-row bee-row-1">
                <div class="bee-row-content">
                    ...
                    <div class="bee-col bee-col-2 bee-col-w7">
                        ...
                        <div class="bee-block bee-block-2 bee-image"><img alt="" class="bee-fixedwidth"
                                src="@/assets/id.png" style="max-width:210px;" /></div>
                        <div class="bee-block bee-block-3 bee-heading">
                            <h1
                                style="color:#f8f8f9;direction:ltr;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:49px;font-weight:normal;letter-spacing:2px;line-height:120%;text-align:left;margin-top:0;margin-bottom:0;">
                                <strong>MINISTERIO ID<br /></strong>EQUIPO DE MISIONES<br />
                            </h1>
                        </div>
...
.bee-row-11 .bee-col-1 .bee-block-4 a,
...
.bee-row-1 {
    ...
    background-image: url('https://4d4ccc483d.imgdist.com/public/users/Integrators/BeeProAgency/1054427_1039607/nasa-Q1p7bh3SHj8-unsplash.png');
...
.bee-row-11 .bee-col-1 .bee-block-4 p:not(:last-child),
.bee-row-3 .bee-col-2 .bee-block-4 p:not(:last-child),
.bee-row-6 .bee-col-2 .bee-block-4 p:not(:last-child),
.bee-row-8 .bee-col-3 .bee-block-4 p:not(:last-child),
...
@media (max-width:768px) {
    ...
    .bee-row-6 .bee-col-2 .bee-block-4,
    .bee-row-8 .bee-col-3 .bee-block-2,
    .bee-row-8 .bee-col-3 .bee-block-2 h1,
    .bee-row-8 .bee-col-3 .bee-block-4 {
        text-align: center !important
    }

    .bee-row-1 .bee-col-2 .bee-block-3 h1 {
...
.bee-row-15 .bee-col-1 .bee-block-1 .bee-icon-image {
    padding: 5px 6px 5px 5px
}

.bee-row-15 .bee-col-1 .bee-block-1 .bee-icon:not(.bee-icon-first) .bee-content {
    margin-left: 0
}
