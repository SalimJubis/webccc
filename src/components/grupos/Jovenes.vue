				...
				<div class="bee-row-content">
					<div class="bee-col bee-col-1 bee-col-w12">
						<div class="bee-block bee-block-1 bee-paragraph">
							<p style="word-break: break-word;"><span>TRES GRUPOS QUE SE ADAPTAN A TU ETAPA</span></p>
				...
				<div class="bee-row-content">
					...
					<div class="bee-col bee-col-2 bee-col-w4" data-aos="fade-right" data-aos-duration="1500">
						...
						<div class="bee-block bee-block-2 bee-text">
							<div class="bee-text-content"
								style="line-height: 120%; font-size: 12px; font-family: inherit; color: #ff6347;">
								<p style="font-size: 16px; line-height: 19px; text-align: center;"><strong style="">TRES
										CUARTOS</strong></p>
							</div>
						</div>
						<div class="bee-block bee-block-3 bee-divider">
					...
					<div class="bee-col bee-col-3 bee-col-w4" data-aos="fade-right" data-aos-duration="1000">
						...
						<div class="bee-block bee-block-2 bee-text">
							<div class="bee-text-content"
								style="line-height: 120%; font-size: 12px; font-family: inherit; color: #ff6347;">
								<p style="font-size: 16px; line-height: 19px; text-align: center;"><strong style="">VIEJA
										ESCUELA</strong></p>
							</div>
						</div>
						<div class="bee-block bee-block-3 bee-divider">
