					...
					<div class="bee-col bee-col-2 bee-col-w4">
						...
						<div class="bee-block bee-block-2 bee-heading" data-aos="fade-right">
							<h1
								...
								<strong>CCC Kids</strong>
							</h1>
						</div>
						<div class="bee-block bee-block-3 bee-paragraph" data-aos="fade-right" data-aos-duration="1000">
							<p style="word-break: break-word;"><span>En CCC Kids ofrecemos un panorama de enseñanza
									entretenida para niños preescolares, escolares y pre adolescentes. Las clases se
									realizan los domingos durante la reunión del culto principal.</span></p>
						</div>
					...
					<div class="bee-col bee-col-2 bee-col-w6">
						...
						<div class="bee-block bee-block-3 bee-heading" data-aos="fade-right" data-aos-duration="1500">
							<h1
								...
								<strong>¡Tenemos 3 grupos dependiendo de la edad de tus hijos!</strong>
							</h1>
						</div>
						<div class="bee-block bee-block-4 bee-divider">
				...
				<div class="bee-row-content">
					<div class="bee-col bee-col-1 bee-col-w4" data-aos="fade-right" data-aos-duration="1000">
						<div class="bee-block bee-block-1 bee-image"><img alt="Sponsoring a Child"
								class="bee-center bee-fixedwidth bee-fullwidthOnMobile" src="@/assets/img/semillitas.jpg"
						...
						<div class="bee-block bee-block-3 bee-heading">
							<h3
								...
								<strong>Semillitas</strong>
							</h3>
						</div>
						<div class="bee-block bee-block-4 bee-paragraph">
							<p style="word-break: break-word;"><span>Corresponde a los niños de edades de preescolar hasta
									segundo básico. Los niños aprenden sus lecciones no solo escuchando la clase, sino
									haciendo actividades creativas que permiten desarrollar habilidades manuales y tener
									actividad física.</span></p>

						</div>
						<br>
						<div class="bee-block bee-block-4 bee-button">
							<button id="quieroParticiparBtn" class="btn btn-primary" data-aos="fade-right"
					...
					<div class="bee-col bee-col-2 bee-col-w4" data-aos="fade-right" data-aos-duration="1500">
						...
						<div class="bee-block bee-block-4 bee-paragraph">
							<p style="word-break: break-word;"><span>Huellas es una clase que considera a niños de tercero y
									cuarto básico. Estos niños pueden leer comprensivamente y se pueden realizar dinámicas
									que desafían sus capacidades manuales e intelectuales.</span></p>
						</div>
					...
					<div class="bee-col bee-col-3 bee-col-w4" data-aos="fade-right" data-aos-duration="1000">
						...
						<div class="bee-block bee-block-3 bee-heading">
							<h3
								style="color:#021332;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:20px;font-weight:normal;letter-spacing:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">
								<strong>Led's Go</strong>
							</h3>
						</div>
						<div class="bee-block bee-block-4 bee-paragraph">
							<p style="word-break: break-word;"><span>Esta clase considera niños de quinto a octavo básico.
									Los niños de esta edad han desarrollado el espíritu crítico y su capacidad racional les
									permite entender conceptos mentales y espirituales más profundos.</span></p>
						</div>
						<div class="bee-block bee-block-5 bee-divider">
							<div class="spacer" style="height:0px;"></div>
						</div>
