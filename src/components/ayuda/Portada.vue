            ...
            <div class="bee-row-content">
                <div class="bee-col bee-col-1 bee-col-w7">
                    ...
                    <div class="bee-block bee-block-2 bee-heading">
                        <h1
                            style="color:white;direction:ltr;font-family:Montserrat, sans-serif;font-size:58px;font-weight:normal;letter-spacing:normal;line-height:100%;text-align:left;margin-top:0;margin-bottom:0;">
                            <strong>NOS MUEVE SERVIR</strong>
                        </h1>
                    </div>
...
.bee-row-5 .bee-col-2,
.bee-row-5 .bee-col-3 {
    border-bottom: 25px solid #f4ded4;
    border-left: 25px solid #f4ded4;
    border-right: 25px solid #f4ded4;
    border-top: 25px solid #f4ded4;
